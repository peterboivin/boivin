/**
 * *****************************************************************************
 * Copyright (c) 2012 Jens Kristian Villadsen. All rights reserved. This program
 ...
 *
 * Contributors: Jens Kristian Villadsen - initial API and implementation
 *****************************************************************************
 */
...
public class GoogleMusicAPI implements IGoogleMusicAPI {
    ...
    private void populateFileWithTuneTags(File file, Tune tune) throws IOException {
        try {
            ...
            tag.setField(FieldKey.ALBUM_ARTIST, tune.getAlbumArtist());
            f.setTag(tag);
            AudioFileIO.write(f);
        } catch (Exception e) {
